      ...
      <div className="flex-1 min-w-0 space-y-5">
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/lis/student/calendar" className="text-xs font-medium text-[#1e3a8a] dark:text-blue-400 hover:underline">
              Full calendar
            </Link>
          </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/lis/student/courses" className="text-xs font-medium text-[#1e3a8a] dark:text-blue-400 hover:underline">
              View all
            </Link>
          </div>
        ...
        <div className="lg:sticky lg:top-6 space-y-5">
          ...
          <div className="rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-sm overflow-hidden">
            ...
            <ul className="divide-y divide-gray-100 dark:divide-slate-800 max-h-[350px] overflow-y-auto">
              {TODO.map((item) => (
                <li key={item.id}>
                  <Link
                    href={`/lis/student/courses/${item.courseId}/assignments`}
          ...
          <div className="rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-sm overflow-hidden">
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-slate-800">
              ...
              <Link href="/lis/student/inbox" className="text-xs font-medium text-[#1e3a8a] dark:text-blue-400 hover:underline">
                View all
              </Link>
            </div>
            <ul className="divide-y divide-gray-100 dark:divide-slate-800">
              {ANNOUNCEMENTS.map((a) => (
                <li key={a.id}>
                  <Link
                    href={`/lis/student/courses/${a.courseId}/announcements`}
...
function CourseCard({ course }: { course: Course }) {
  return (
    <article className="group bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-sm hover:shadow-lg transition-all duration-200 overflow-hidden flex flex-col">
      ...
      <Link href={`/lis/student/courses/${course.id}`} className="block relative h-[120px] flex-shrink-0 overflow-hidden">
        <img
          src={course.image}
          alt={course.name}
      ...
      {/* Term */}
      <Link href={`/lis/student/courses/${course.id}`} className="block px-4 pt-2 pb-2">
      ...
      <div className="px-3 py-2 flex items-center gap-0.5">
        {[
          { href: `/lis/student/courses/${course.id}/announcements`, icon: Bell,          label: "Announcements", badge: course.announcements },
          { href: `/lis/student/courses/${course.id}/assignments`,   icon: FileText,      label: "Assignments",   badge: course.assignments  },
          { href: `/lis/student/courses/${course.id}/grades`,            icon: BarChart3,     label: "Grades"                                    },
