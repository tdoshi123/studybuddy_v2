    ...
    <div className="w-full">
      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-6">
          {/* Profile */}
          <SectionCard id="profile" icon={User} title="Profile" description="Your name and school information">
            <div className="flex items-center gap-5 px-7 py-6 border-b border-gray-50 dark:border-slate-800/60">
              ...
              <div>
                <p className="text-lg font-bold text-gray-900 dark:text-white">{user?.fullName ?? "Student"}</p>
                <p className="text-sm text-gray-400 dark:text-slate-500 mt-0.5">{user?.primaryEmailAddress?.emailAddress ?? "student@school.edu"}</p>
          ...
          <SectionCard id="notifications" icon={Bell} title="Notifications" description="Choose which events trigger a notification">
            {([
              ...
              { key: "assignmentReminders", label: "Assignment reminders",   desc: "New assignments and updates" },
              { key: "dueDateReminders",    label: "Due date reminders",     desc: "Reminders before assignments are due" },
              { key: "courseAnnouncements",  label: "Course announcements",   desc: "Updates from your teachers" },
              { key: "teacherMessages",     label: "Teacher messages",       desc: "Direct messages from teachers" },
              { key: "calendarReminders",   label: "Calendar reminders",     desc: "Upcoming events and schedule changes" },
