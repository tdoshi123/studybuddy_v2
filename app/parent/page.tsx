    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
          Welcome back, {firstName} — here's how your children are doing
        </p>
      </div>
              ...
              <div className="p-5">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    { label: "Due Soon",   value: String(child.dueSoon), icon: Clock,   color: "text-amber-600"   },
                ...
                >
                  View {child.name.split(" ")[0]}'s courses
      ...
      <section>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            { label: "Calendar",  icon: Calendar,      href: "/calendar",  color: "bg-blue-50   dark:bg-blue-950/40   text-blue-600"   },
            { label: "Messages",  icon: Mail,           href: "/messages",  color: "bg-purple-50 dark:bg-purple-950/40 text-purple-600" },
            { label: "Grades",    icon: GraduationCap, href: "/grades",    color: "bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600" },
            { label: "Reports",   icon: FileText,       href: "/inbox",     color: "bg-amber-50  dark:bg-amber-950/40  text-amber-600"  },
