...
import { User, Bell, Users, Settings, Upload, Mail, Phone, Moon, Sun, Monitor, Globe, Clock, Eye, EyeOff, MessageSquare, BookOpen, GraduationCap, Calendar, Megaphone, LogOut, RefreshCw } from "lucide-react";
...
function ToggleSwitch({ enabled, onChange }: ToggleSwitchProps) {
  return (
    <button
      ...
      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${enabled ? "bg-[#1e3a8a]" : "bg-gray-200 dark:bg-gray-700"
        }`}
    >
      <span
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          {currentRole && (
            <Link
              href="/onboarding"
              className="flex items-center gap-2 px-3 py-2 text-sm border border-gray-200 dark:border-slate-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors"
            >
        ...
        <div>
          <div className="space-y-6">
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-3">
                    <button className="flex items-center gap-2 px-4 py-2 bg-[#1e3a8a] text-white rounded-lg hover:bg-[#1e293b] transition-colors text-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-[#1e3a8a] focus:border-transparent outline-none transition-all"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-[#1e3a8a] focus:border-transparent outline-none transition-all"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="flex justify-end">
              <button className="px-6 py-2.5 bg-[#1e3a8a] text-white rounded-lg hover:bg-[#1e293b] transition-colors font-medium">
                Save Changes
              </button>
            </div>
          </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    return (
                      ...
                      >
                        <Icon className={`w-6 h-6 ${theme === option.value ? "text-[#1e3a8a]" : "text-gray-400"}`} />
                        <span className={`text-sm font-medium ${theme === option.value ? "text-[#1e3a8a]" : "text-gray-700 dark:text-gray-300"}`}>
                          {option.label}
                        </span>
                      </button>
                    );
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-[#1e3a8a] focus:border-transparent outline-none appearance-none"
                    >
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-[#1e3a8a] focus:border-transparent outline-none appearance-none"
                  >
