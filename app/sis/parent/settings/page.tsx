        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          <SectionCard id="profile" icon={User} title="Profile" description="Your name and contact information">
            <div className="flex items-center gap-5 px-7 py-6 border-b border-gray-50 dark:border-slate-800/60">
              <div className="relative flex-shrink-0">
                <div className="w-20 h-20 rounded-2xl bg-[#166534] flex items-center justify-center text-white text-2xl font-bold select-none">
              ...
              <div>
                <p className="text-lg font-bold text-gray-900 dark:text-white">{user?.fullName ?? "Parent"}</p>
                <p className="text-sm text-gray-400 dark:text-slate-500 mt-0.5">{user?.primaryEmailAddress?.emailAddress ?? "parent@email.com"}</p>
                <span className="inline-block mt-2 text-[11px] font-bold px-2.5 py-1 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-400 rounded-full uppercase tracking-wide">
                  Parent / Guardian
                </span>
              </div>
            </div>
          ...
          <SectionCard id="notifications" icon={Bell} title="Notifications" description="Choose which events trigger a notification">
            {([
              ...
              { key: "attendanceAlerts",    label: "Attendance alerts",      desc: "When your child is marked absent or tardy" },
