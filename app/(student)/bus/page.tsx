      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-full bg-[#1e3a8a]/10 flex items-center justify-center">
            <Bus className="w-7 h-7 text-[#1e3a8a]" />
          </div>
          <div>
          ...
          <div className="divide-y divide-gray-100 dark:divide-gray-800">
            {MOCK_STOPS.map((stop, index) => (
              <div key={index} className="px-4 py-3 flex items-center gap-3">
                <div className={`w-3 h-3 rounded-full ${stop.isNext ? 'bg-[#1e3a8a]' : 'bg-gray-300 dark:bg-gray-600'}`} />
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800">
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium text-[#1e3a8a]">7:35 AM</span>
            </div>
          </div>
        </div>
      </div>
