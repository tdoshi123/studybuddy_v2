...
const TEACHER_COURSES = [
  { id: "c1", name: "Mathematics 9", code: "Section A · Grade 9" },
  { id: "c2", name: "Mathematics 10", code: "Section B · Grade 10" },
  { id: "c3", name: "Algebra I", code: "Section C · Grade 8" },
];
...
export function SecondarySidebar() {
  ...
  const courses = isTeacher ? TEACHER_COURSES : ENROLLED_COURSES;
  const allCoursesHref = isTeacher ? "/lis/teacher/courses" : "/lis/student/courses";
  const courseBaseHref = isTeacher ? "/lis/teacher/courses" : "/lis/student/courses";
      ...
      {isSecondaryOpen && (
        ...
        >
          ...
          <nav className="flex-1 overflow-y-auto p-3 space-y-0.5">
            ...
            {courses.map((course) => {
              const courseHref = `${courseBaseHref}/${course.id}`;
              const isActive =
                pathname === courseHref || (pathname?.startsWith(`${courseHref}/`) ?? false);
